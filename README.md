...
| optional `http://*/*`, `https://*/*` | the bubble on sites other than YouTube and Studio. Not asked at install: Chrome asks the first time you turn the bubble on in the popup, and it is given back when you turn it off |
